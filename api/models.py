...
class UserMerch(models.Model):
    user = models.ForeignKey(
        ...
        related_name="owned_merch",
        db_index=True,
    )
    merch = models.ForeignKey(
        "Merch", on_delete=models.CASCADE, related_name="owners", db_index=True
    )
...
class Transaction(models.Model):
    ...
    user = models.ForeignKey(
        "registration.CustomUser", on_delete=models.CASCADE, related_name="transactions"
    )
